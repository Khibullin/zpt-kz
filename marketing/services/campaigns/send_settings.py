...
MARKETING_SIMPLE_WAVE_SIZE_DEFAULT = 10
MARKETING_SIMPLE_WAVE_INTERVAL_MINUTES_DEFAULT = 5
...
MARKETING_SIMPLE_WAVE_SIZE_MIN = 1
MARKETING_SIMPLE_WAVE_SIZE_MAX = 100
MARKETING_SIMPLE_WAVE_INTERVAL_MIN = 1
MARKETING_SIMPLE_WAVE_INTERVAL_MAX = 60
...
def get_marketing_simple_wave_size() -> int:
    return _read_bounded_int(
        'MARKETING_SIMPLE_WAVE_SIZE',
        'MARKETING_SIMPLE_WAVE_SIZE',
        MARKETING_SIMPLE_WAVE_SIZE_DEFAULT,
        minimum=MARKETING_SIMPLE_WAVE_SIZE_MIN,
        maximum=MARKETING_SIMPLE_WAVE_SIZE_MAX,
    )


def get_marketing_simple_wave_interval_minutes() -> int:
    return _read_bounded_int(
        'MARKETING_SIMPLE_WAVE_INTERVAL_MINUTES',
        'MARKETING_SIMPLE_WAVE_INTERVAL_MINUTES',
        MARKETING_SIMPLE_WAVE_INTERVAL_MINUTES_DEFAULT,
        minimum=MARKETING_SIMPLE_WAVE_INTERVAL_MIN,
        maximum=MARKETING_SIMPLE_WAVE_INTERVAL_MAX,
    )
