...
NEW_FIRST_LINE = (
    ...
    'Предложение для магазинов автозапчастей, продавцов и СТО.'
)


def update_ag_parts_wholesale_template_first_line(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('marketing', '0013_ag_parts_wholesale_template_avtozapchasti'),
    ]

    operations = [
        migrations.RunPython(
            update_ag_parts_wholesale_template_first_line,
