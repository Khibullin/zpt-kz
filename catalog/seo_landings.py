...
SEO_BRAND_LANDINGS = {
    ...
    'geely': {
        'brand_name': 'Geely',
        'title': 'Запчасти Geely в Казахстане — каталог и цены | ZPT.KZ',
        'meta_description': (
            'Автозапчасти Geely в Казахстане: фильтры, расходники и другие детали. '
            'Смотрите актуальные предложения продавцов ZPT.KZ или оставьте заявку на подбор.'
        ),
        'h1': 'Автозапчасти Geely в Казахстане',
        'intro': (
            'На ZPT.KZ собраны активные предложения запчастей и расходных материалов для Geely. '
            'Сверяйте артикул и применяемость в карточке товара, а если нужной позиции нет — '
            'оставьте заявку продавцам автозапчастей по Казахстану.'
        ),
    },
    'haval': {
        'brand_name': 'Haval',
    ...
    'jac': {
        'brand_name': 'JAC',
        'title': 'Запчасти JAC в Казахстане — каталог автозапчастей | ZPT.KZ',
        'meta_description': (
            'Автозапчасти JAC в Казахстане: фильтры, расходники и детали для J7, JS3, JS4, '
            'JS6, S3 и других моделей. Каталог и заявка на подбор через ZPT.KZ.'
        ),
        'h1': 'Автозапчасти JAC в Казахстане',
        'intro': (
            'На ZPT.KZ собраны предложения запчастей и расходных материалов для автомобилей JAC. '
            'Проверяйте артикул и применяемость к модели в карточке товара, а если нужной позиции '
            'нет — отправьте заявку продавцам автозапчастей по Казахстану.'
        ),
    },
    'zeekr': {
        'brand_name': 'Zeekr',
