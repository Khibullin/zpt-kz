...
STAGE3_AIR_FILTERS = {
    '1109110XKV08A': {
        ...
        'preferred_legacy_pk': 2046,
    },
}

STAGE3_AIR_FILTER_ARTICLES = frozenset(STAGE3_AIR_FILTERS)
APPROVED_AIR_FILTER_ARTICLES = (
    STAGE1_AIR_FILTER_ARTICLES | STAGE2_AIR_FILTER_ARTICLES | STAGE3_AIR_FILTER_ARTICLES
)

PHOTO_ALIASES = {
    'J61109111': 'J691109111',
    '1109110XKVO8A': '1109110XKV08A',
}
