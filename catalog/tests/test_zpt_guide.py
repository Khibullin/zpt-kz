...
class ZptGuidePageTests(TestCase):
    ...
    def test_guide_page_renders_faq_first_and_separate_sections(self):
        ...
        self.assertContains(response, '<div class="zpt-guide__install-wrap"')
        self.assertContains(response, 'data-zpt-pwa-panel')
        self.assertNotContains(response, '<p class="zpt-guide__install-wrap"')
